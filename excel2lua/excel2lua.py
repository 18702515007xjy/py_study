...
print(os.path.abspath(sys.argv[0]))     # 返回path规范化的绝对路径  
print(curpath)                          # os.path.dirname(path)返回path的目录
...
# C:\Users\RC-W\Desktop\excel2lua_xml_json_ts\excel转lua\excel2lua.py
# C:\Users\RC-W\Desktop\excel2lua_xml_json_ts\excel转lua
# C:\Users\RC-W\Desktop\excel2lua_xml_json_ts\excel转lua
# ..
# C:\Users\RC-W\Desktop\excel2lua_xml_json_ts 
...
if __name__ == '__main__':
    ...
    # code here
    # excel2lua(os.path.join(curpath, ("game_etc.xlsx")), os.path.join(curpath, "game_etc.lua"))
